...
`public/images/` and are referenced by these exact strings in the code.
...
- The remaining portrait shots were distributed across the Benefits grid
  and the four Pricing cards by composition: action/lift shots read well as
  small square crops (Benefits grid), while clean standing shots work best
  as the taller pricing-card photos.
- One high-resolution portrait is reused for both a Benefits grid tile and
  the Reach Out / Contact panel, since it was the sharpest file and suits a
  larger crop.
...
brief, the following were intentionally changed from the reference:
Login was removed from the nav, the orange "Join Us On Mobile" app-download
section was removed entirely, the footer newsletter/subscribe block was
removed, all "Buy Now" actions were changed to open WhatsApp instead of a
checkout, and the 3 reference pricing cards became your exact 4 packages
(Basic, Standard, Premium, Group Training).
